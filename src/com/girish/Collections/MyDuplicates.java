...
public class MyDuplicates {
    ...
    public static void main(String a[]){
        ...
        boolean b=ts.add(new Emp(146,"Tom",20000));
        System.out.println("added 1st time : "+b);
        ts.add(new Emp(543,"Abdul",10000));
        ts.add(new Emp(12,"Dinesh",50000));
        //adding duplicate entry
        boolean b1=ts.add(new Emp(146,"Tom",200001));
        System.out.println("added 2nd time : "+b1);
        ts.add(new Emp(543,"Abdul",1000023));
...
class EmpComp implements Comparator<Emp>{
    ...
    public int compare(Emp e1, Emp e2) {
        if(e1.getEmpId() == e2.getEmpId()){
        	System.out.println("Duplicate eliments are:"+e1.getEmpId()+" : "+e1.getEmpName()+" : "+e1.getEmpSal());
            return 0;
        } if(e1.getEmpId() < e2.getEmpId()){
            return 1;
        } else {
